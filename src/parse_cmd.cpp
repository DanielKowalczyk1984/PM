...
// Usage:
//   bin/PM [-S <kn> -pmBRZH -n <nl> -b <br> -a <ln> -l <x> -f <y> -d
//   --no_strong_branching --alpha <mn>] FILE NB bin/PM (-h | --help) bin/PM
//   --version
...
//   -S --stab_method=<kn>         Stabilization technique: 0 = no
//   stabilization, 1 = stabilization wentgnes, 2 = stabilization
//   dynamic[default: 1]. -a --pricing_solver=<ln>      Set pricing solver: 0 =
//   bdd backward cycle, 1 = bdd forward simple, 2 = bdd forward cycle,
//                                                     3 = bdd backward simple,
//                                                     4 = bdd backward cycle, 5
//                                                     = zdd forward simple, 6 =
//                                                     zdd forward cycle, 7 =
//                                                     zdd backward simple, 8 =
//                                                     zdd backward cycle, 9 =
//                                                     TI solver, 10 = arc-TI
//                                                     solver, 11 = hybrid model
//                                                     TI and bdd backward
//                                                     cycle[default: 4].
//   -l --cpu_limit=<x>            Cpu time limit for branch and bound
//   method[default: 7200]. -f --nb_rvnb_it=<y>           Number of iterations
//   in RVND[default: 4].
//   --alpha=<mn>                  Stabilization factor[default: 0.8].
//   -p --print_csv                Print csv-files.
//   -m --mip_solver               Use mip solver to solve the original
//   formulation. -R --no_rc_fixing             Don't apply reduce cost fixing.
...
//   -b --branching_strategy=<br>  Set branch-and-bound exploration strategy: 0
...
//   meaning that all nodes should be explored.
// )";
...
//     auto args = docopt::docopt(USAGE, {argv + 1, argv + argc}, true, "PM
//     0.1");
...
//     val =
//     parms->parms_set_nb_machines(static_cast<int>(args["NB"].asLong()));
