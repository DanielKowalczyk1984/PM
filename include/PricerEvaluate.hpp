...
// struct ForwardZddCycleDouble : ForwardZddCycle<double> {
//     ForwardZddCycleDouble(double* _pi, int _num_jobs)
//         : ForwardZddCycle<double>(_pi, _num_jobs){};
//     explicit ForwardZddCycleDouble(int _num_jobs)
//         : ForwardZddCycle<double>(_num_jobs){};
//     ForwardZddCycleDouble() : ForwardZddCycle<double>(){};
// };
