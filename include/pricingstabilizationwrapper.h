...
//                                                 Parms*        parms);
// void delete_pricing_stabilization(PricingStabilization*
// pricing_stabilization); double call_get_eta_in(PricingStabilization*
// pricing_stabilization); double call_get_reduced_cost(PricingStabilization*
// pricing_stabilization); int    call_stopping_criteria(PricingStabilization*
// pricing_stabilization); int call_get_update_stab_center(PricingStabilization*
// pricing_stabilization); void   call_update_duals(PricingStabilization*
// pricing_stabilization); void   call_remove_constraints(PricingStabilization*
