if(GUROBI_INCLUDE_DIR)
  ...
  string(REGEX MATCH "#define GRB_VERSION_MAJOR *([0-9]+)" _dummy
               "${GUROBI_C_H_CONTENTS}")
  set(GRB_VERSION_MAJOR "${CMAKE_MATCH_1}")
  string(REGEX MATCH "#define GRB_VERSION_MINOR *([0-9]+)" _dummy
               "${GUROBI_C_H_CONTENTS}")
  set(GRB_VERSION_MINOR "${CMAKE_MATCH_1}")
  string(REGEX MATCH "#define GRB_VERSION_TECHNICAL *([0-9]+)" _dummy
               "${GUROBI_C_H_CONTENTS}")
