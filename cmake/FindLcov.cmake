...
function(lcov_capture_tgt TNAME)
  ...
  add_custom_target(
    ${TNAME}-genhtml
    COMMAND
      ${GENHTML_BIN} --quiet --sort --prefix ${PROJECT_SOURCE_DIR}
      --baseline-file ${LCOV_DATA_PATH_INIT}/${TNAME}.info --output-directory
      ${LCOV_HTML_PATH}/${TNAME} --title
      "${CMAKE_PROJECT_NAME} - target ${TNAME}" ${GENHTML_CPPFILT_FLAG}
      ${OUTFILE}
...
function(lcov_capture)
  ...
  if(NOT TARGET lcov)
    ...
    add_custom_target(
      lcov
      COMMAND
        ${GENHTML_BIN} --quiet --sort --baseline-file
